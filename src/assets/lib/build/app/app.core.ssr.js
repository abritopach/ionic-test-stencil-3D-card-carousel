...
var s=document.querySelector("script[data-core='app.core.ssr.js'][data-path]");if(s){publicPath=s.getAttribute('data-path');}
(function(publicPath){
...
(function(window, document, Context, appNamespace, publicPath) {
  ...
  function initElementListeners(plt, elm) {
    ...
    cmpMeta.listenersMeta && cmpMeta.listenersMeta.forEach(listener => {
  ...
  function createListenerCallback(elm, eventMethodName) {
    ...
    return ev => {
      elm._instance ? elm._instance[eventMethodName](ev) : (elm._queuedEvents = elm._queuedEvents || []).push(eventMethodName, ev);
    };
  }
  ...
  function initEventEmitters(plt, componentEvents, instance) {
    componentEvents && componentEvents.forEach(eventMeta => {
