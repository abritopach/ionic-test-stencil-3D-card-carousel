...
App.loadStyles("st-3d-card-carousel","st-3D-card-carousel h2 {\n  margin-top: 5px;\n  color: white;\n  font-size: 25px;\n}\n\nst-3D-card-carousel i {\n  color: #3E2723;\n}\n\n\@keyframes resize {\n  0% {\n    transform: scale(1);\n  }\n  50% {\n    transform: scale(1.2);\n  }\n  100% {\n    transform: scale(1);\n  }\n}\n\nst-3D-card-carousel .carousel-container {\n  padding: 70px 0;\n  margin: 50px auto;\n  width: 200px;\n  height: 550px;\n  position: relative;\n  perspective: 1000px;\n  touch-action: pan-y;\n}\n\nst-3D-card-carousel .carousel {\n  height: 100%;\n  width: 100%;\n  position: absolute;\n  transform-style: preserve-3d;\n  transition: transform 1s;\n}\n\nst-3D-card-carousel .carousel img {\n  width: 200px;\n  height: 200px;\n  margin-top: 10px;\n}\n\nst-3D-card-carousel .carousel-slide-item {\n  display: block;\n  position: absolute;\n  background: #000;\n  width: 200px;\n  height: auto;\n  font-size: large;\n  text-align: center;\n  color: #FFF;\n  opacity: 0.95;\n  border-radius: 10px;\n}\n\nst-3D-card-carousel .carousel-slide-item div {\n  width: 200px;\n  height: 20px;\n}\n\nst-3D-card-carousel .slide-item-animation {\n  animation-name: resize;\n  animation-duration: 3s;\n  animation-timing-function: ease-in-out;\n  animation-iteration-count: 1;\n  -webkit-animation-name: resize;\n  -webkit-animation-duration: 3s;\n  -webkit-animation-timing-function: ease-in-out;\n  -webkit-animation-iteration-count: 1;\n  -moz-animation-name: resize;\n  -moz-animation-duration: 3s;\n  -moz-animation-timing-function: ease-in-out;\n  -moz-animation-iteration-count: 1;\n  -o-animation-name: resize;\n  -o-animation-duration: 3s;\n  -o-animation-timing-function: ease-in-out;\n  -o-animation-iteration-count: 1;\n}\n\nst-3D-card-carousel .left {\n  width: 100px !important;\n  float: left;\n}\n\nst-3D-card-carousel .right {\n  width: 100px !important;\n  float: right;\n}\n\n\@media screen and (max-width: 25em) {\n  st-3D-card-carousel .carousel-container {\n    padding: 70px 0;\n    margin: 50px auto;\n    width: 250px;\n    height: 550px;\n    position: relative;\n    perspective: 1000px;\n  }\n  st-3D-card-carousel .carousel {\n    height: 100%;\n    width: 100%;\n    position: absolute;\n    transform-style: preserve-3d;\n    transition: transform 1s;\n  }\n  st-3D-card-carousel .carousel img {\n    width: 200px;\n    height: 200px;\n    margin-top: 10px;\n  }\n  st-3D-card-carousel .carousel-slide-item {\n    display: block;\n    position: absolute;\n    background: #000;\n    width: 200px;\n    height: auto;\n    font-size: large;\n    text-align: center;\n    color: #FFF;\n    opacity: 0.95;\n    border-radius: 10px;\n  }\n  st-3D-card-carousel .carousel-slide-item div {\n    width: 200px;\n    height: 20px;\n    font-size: 15px;\n  }\n}\nst-3d-card-carousel.hydrated{visibility:inherit}","test-carousel","test-carousel {\n  font-family: Courier New, Courier, monospace;\n  font-weight: bold;\n}\ntest-carousel.hydrated{visibility:inherit}");
App.loadComponents(
...
class St3DCardCarousel {
    ...
    render() {
        const items = this.items.map((item, index) => {
            ...
            return (h("div", { class: myClass, style: divStyle, onClick: () => this.onHandleClick(this.items[index]) },
                h("img", { src: item.imgUrl }),
                h("h2", null, item.title),
                h("p", null,
                    h("i", { class: "fa fa-flag" }),
                    " ",
                    item.country),
                ...
                h("div", null,
                    ...
                    h("div", { class: "right" },
                        "4 ",
                        h("i", { class: "fa fa-comments" })))));
        });
        return (h("div", { class: "carousel-container" },
            h("div", { class: "carousel" }, items)));
    }
}
...
class TestCarousel {
    ...
    render() {
        return (h("div", null,
            h("st-3D-card-carousel", { slides: this.slides }),
            h("button", { onClick: this.handleClick.bind(this) }, "Load more")));
    }
}

exports['st-3d-card-carousel'] = St3DCardCarousel;
exports['test-carousel'] = TestCarousel;
},


/***************** st-3d-card-carousel *****************/
[
/** st-3d-card-carousel: tag **/
"st-3d-card-carousel",

/** st-3d-card-carousel: members **/
[
  [ "myNameEl", /** element ref **/ 7, /** do not observe attribute **/ 0, /** type any **/ 1 ],
  [ "slides", /** prop **/ 1, /** observe attribute **/ 1, /** type any **/ 1 ]
],

/** st-3d-card-carousel: host **/
{},

/** st-3d-card-carousel: events **/
[
  [
    /*****  st-3d-card-carousel selectedItem ***** /
    /* event name ***/ "selectedItem"
  ]
]
...
/** test-carousel: members **/
[
  [ "slides", /** state **/ 5, /** do not observe attribute **/ 0, /** type any **/ 1 ]
],
